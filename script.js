...
export function init(){
    ...
    const pantingSound = document.getElementById('pantingSound');
  ...
  function levelUp(){
        if(score <= 100){
           if(!gameOver) bgm.play();
            ...
            if(!gameOver) brown_fox_bgm.play();
            ...
            if(!gameOver) silver_fox_bgm.play();
